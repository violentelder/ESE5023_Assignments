...
library(maps)
library(RNetCDF)
setwd("D://ESE5023/Final Project/Data")

outDir <- file.path("D:/ESE5023/Final Project/Output/LAI_MONTHLY_MEAN")
Num <- c("08", "09", "10", "11", "12", "01", "02", "03", "04", "05", "06", "07")
month <- c("August", "September", "October", "November", 
           "December", "January", "February", "March", 
           "April", "May", "June", "July")

# Open the NetCDF filec
ex.nc <- open.nc("LAI_mean_monthl_1981-2015.nc4")
...
for (i in 1:12) {
  LAI_T_Jan <- LAI_T[,,i]
  #文件命名
  name <- paste(outDir,"/","LAI_mean_monthly_1981-2015_",Num[i], "_",month[i],".png", sep = "")
  #保存图片
  # Set the png format
  png(name, 
      width=12.75, 
  ...
  title(main=paste("Climatological Mean", month[i], "LAI for the 1981-2015"),
